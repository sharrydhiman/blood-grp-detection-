...
if data['training_data'].shape[0] == 0 or data['training_labels'].shape[0] == 0:
    ...
    y_pred_rf = rf_model.predict(data['validation_data'])
    ...
    for blood_group in blood_group_labels:
        ...
        y_pred_rf_blood_group = rf_model.predict(validation_data_blood_group)
    ...
    # saving model
    with open('C:/Users/sharr/Desktop/SMLPROJECT/rf_model.pkl', 'wb') as f:
